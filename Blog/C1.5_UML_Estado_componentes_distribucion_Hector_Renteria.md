...
1. Instale dentro de visual studio code **Draw.io** a través de las siguientes extensiones:
   ...
   ### Diagrama de secuencia utilizando drawio</strong>

      - ![DiagramaS"](/Img/DiagramaSecuencias2.png)

2. Elabore los siguientes diagramas:
   + Diagrama de **de estados**

 ![E](../img/../Diagrams/Diagrama_Estados.png)

   + Diagrama de **de componentes**

 ![E](../img/../Diagrams/Diagrama_Componentes.png)

   + Diagrama de **de distribución**

 ![E](../img/../Diagrams/Diagrama_Distribución.png)
___
