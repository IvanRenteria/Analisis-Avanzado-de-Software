...
<tbody>
<br>
<h3>Tipo de sistema del Caso de estudio 3: Búsqueda del conocimiento</h3>

<br>
<h5>Software de aplicación</h5>
<p>De acuerdo con la información encontrada, el tipo de sistema de Software que pertenece este caso de estudio es el de Software de aplicación, ya que cumple con varias necesidades específicas para el usuario y también contiene algunas de las herramientas para la búsqueda y manejo de información dentro del mismo utilizando un dispositivo móvil o computadores.

<p>Algunas características de este tipo de sistema son: </p>

<li>Satisface una necesidad específica.</li>
