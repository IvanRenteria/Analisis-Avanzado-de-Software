...
| Tipo de proyecto:    |Aplicación móvil/Escritorio|
| Patrocinador:        | Zerox                      |
...
|Interfaz de inicio funcional|
|Conexión a la Base de Datos|
|Plantilla de creación de tópicos|
|Integración de barra de búsqueda|
|Filtro de tópicos mejor puntuados|
|Apartado de previsualización de tópicos|
|Inscripción a tópicos|
...
| Restricciones|
| -------------                              |
|El alcance hacia los usuarios.|
|Sostenibilidad de la aplicación.|
...
|JAIME LEONARDO ENRIQUEZ ALVAREZ|Patrocinador|--||
