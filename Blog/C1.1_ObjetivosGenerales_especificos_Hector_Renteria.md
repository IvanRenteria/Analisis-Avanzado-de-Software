...
1. Especifique el  **Objetivo general** del caso de estudio, recordándose que se debe indicar lo que se busca con el proyecto.
   * Brindar a los usuarios de la empresa la facilidad de encontrar tópicos que necesiten así como poder redactarlos por medio de la aplicación de la empresa.
2. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.
   * Definir una plataforma donde cualquier usuario de la empresa pueda hacer uso de tópios creados por los mismos usuarios de la empresa. 
   * Reducir el tiempo de búsqueda de los usuarios al momento de buscar información en otras plataformas referente a soluciones o problemas dentro del área de la empresa.
   * Aumentar el número de personas con el conocimiento requerido utilizando los tópicos de otros usuarios dentro de la plataforma de la empresa.
...
![Sistemas](../Img/Modelo_de_Negocio.png)
___
