...
1. Develop diagrams for each of the views set out in the 4+1 architecture model.
    ...
    ![Escenarios](../Diagrams/A2.2_Diagrama_Vista_Escenarios1.png)
    - [x] Logic View: Class Diagram 
      ![Logica](../Diagrams/A2.2_Diagrama_Vista_Clases.png)
    - [x] Process View: Sequence Diagram
      ![Procesos](../Diagrams/A2.2_Diagrama_Vista_Secuencia.png)
    - [x] Developer view: Component Diagram
      ![desarrollo](../Diagrams/A2.2_Diagrama_Vistas_Desarrollo.png)
    - [x] Physical View: Distribution Diagram
      ![Fisica](../Diagrams/A2.2_Diagrama-Vista_Distribucion.png)
